namespace Factotum.Gui.Chrono.Controls
{
	partial class GregorianDateControl
	{
		...
		private void InitializeComponent()
		{
			...
			this._cbIsExact.Dock = System.Windows.Forms.DockStyle.Fill;
			this._cbIsExact.Location = new System.Drawing.Point(4, 14);
			this._cbIsExact.Margin = new System.Windows.Forms.Padding(4, 0, 0, 0);
			this._cbIsExact.Name = "_cbIsExact";
			this._cbIsExact.Size = new System.Drawing.Size(117, 28);
            ...
            0,
            0});
			this._nudYear.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            0,
            0});
			this._nudMonth.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            0,
            0});
			this._nudDay.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
