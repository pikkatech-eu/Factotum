...
{
	public partial class TemporalControl : UserControl, ITemporalDevice
	{
		...
		private void OnParseTemporal(object sender, EventArgs e)
		{
			Temporal t = null;

			if (Temporal.TryParse(this._txTemporal.Text, out t))
			{
				this._ctrlStart.GregorianDate	= t.Start;
				this._ctrlEnd.GregorianDate		= t.End;
			}
		}
